...
<div class="flex justify-center">
    <div class="card w-1/2">
        <div class="py-5 px-10">
            ...
            <p class="text-center text-sm text-gray-500 mb-8">{{ __('Not got an account?') }} <a class=" text-sm text-blue-500" href="{{ route('register') }}">Register now!</a></p>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group row">
                    <label for="email" class="text-gray-500 text-sm">{{ __('E-Mail Address') }}</label>
                        ...
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="john@doe.co.uk">
